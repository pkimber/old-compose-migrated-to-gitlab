...
ARTICLE_TYPE_LEFT = 'pull-left'
ARTICLE_TYPE_RIGHT = 'pull-right'
ARTICLE_TYPE_TOP = 'w-100'
ARTICLE_TYPE_BOTTOM = 'w-100'
ARTICLE_TYPE_TEXT_ONLY = 'hidden'
ARTICLE_TYPE_PICTURE_ONLY = 'visible'

ARTICLE_IMAGE_SIZE_FULL = 'col-12'
ARTICLE_IMAGE_SIZE_QUARTERS = 'col-9'
ARTICLE_IMAGE_SIZE_THIRDS = 'col-8'
...
ARTICLE_IMAGE_SIZE_CHOICES = (
    ...
    (ARTICLE_IMAGE_SIZE_QUARTERS, '2 Quarters Width'),
