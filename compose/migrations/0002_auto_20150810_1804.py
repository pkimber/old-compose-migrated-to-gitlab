...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='article',
            name='link',
            field=models.ForeignKey(blank=True, related_name='article_link', null=True, to='block.Link'),
        ),
        migrations.AddField(
            model_name='article',
            name='references',
        ...
        migrations.AlterField(
            model_name='article',
            name='picture',
            field=models.ForeignKey(blank=True, related_name='article_picture', null=True, to='block.Image'),
        ),
    ]
