...
class Holding(ContentModel):
    ...
    def url_publish(self):
        return reverse('compose.holding.publish', kwargs={'pk': self.pk})

    def url_update(self):
        return reverse('compose.holding.update', kwargs={'pk': self.pk})
...
class Title(ContentModel):
    ...
    def url_publish(self):
        return reverse('compose.title.publish', kwargs={'pk': self.pk})

    def url_update(self):
        return reverse('compose.title.update', kwargs={'pk': self.pk})
